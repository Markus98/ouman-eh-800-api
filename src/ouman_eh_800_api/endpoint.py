...
from .const import ControlEnum, HomeAwayControl, OperationMode, OumanUnit
...
class SystemEndpoints(OumanRegistry):
    ...
    RELAY_STATUS_TEXT_2 = OumanEndpoint(
        name="relay_status_text_2",
        unit=OumanUnit.TEXT,
        sensor_endpoint_id="S_1004_0",
    )
...
class L2Endpoints(OumanRegistry):
    INSTALLED_STATUS = OumanEndpoint(
